            ...
            <div className="h-14 w-full border-b border-zin-200 flex items-center justify-between px-2">
                <div className="flex items-center gap-1.5">
                    <Button
                        ...
                        onClick={() => { setCurrentPage((prev) => (prev - 1 > 1 ? prev - 1 : 1)); setValue("page", String(currentPage - 1)) }}
                    ...
                    <Button
                        ...
                        onClick={() => { setCurrentPage((prev) => prev + 1 > numPages! ? numPages! : prev + 1); setValue("page", String(currentPage + 1)) }} variant={'ghost'} aria-label='next page'>
