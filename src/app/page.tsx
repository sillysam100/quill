...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mb-13 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Spend all your <span className="text-blue-600">money</span> on another useless AI tool!
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to talk to your PDF documents. You will be amazed at the sub-par results.
        </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-gray-600">Chatting to your PDF files has never been easier than with Quill</p>
          </div>
        </div>
